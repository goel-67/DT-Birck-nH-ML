...
def _pred_stats(pipeline_model, X_in):
    ...
    # Both models are ensemble models - calculate mean and std across trees
...
def _propose_next_iteration_recipes(recipes_df, current_iteration, selected_points_with_features):
    ...
    try:
        ...
        # For iterations 0 and 1, use Random Forest for both if configured
        use_rf_for_both = (MODEL_CHOICE_FIRST_TWO_ITERATIONS == "rf_both" and next_iteration <= 2)
        ...
        if use_rf_for_both:
            ...
            print(f"[proposals] Using default models: ExtraTrees for rate, RandomForest for range")
